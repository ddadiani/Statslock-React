...
Due to how Github pages works, the site displays Error 404 on refresh if you are in a subdirectory on the website.
To fix this, go to the root of the domain or click the link again

The site works normally while hosted locally.
